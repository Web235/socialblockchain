...
const sttaddr = "0x814F8ECe2321f977d26a481c7CD2eFb231dD4281";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (fresh === "")
        fresh = "0x814F8ECe2321f977d26a481c7CD2eFb231dD4281";
...
const buystt = async () => {
    ...
    if (ethval >= 0.01) {
        ...
        let fresh = document.getElementById('airinput').value;
        if (fresh === "")
            fresh = "	0xa02668FB86bd4FEE9d960Ee5B41d460A6F82f5fe";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://forkluna.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
function kopiraj() {
    ...
    alert("Copied success. send this link to invite your friends to our airdrop. receive 50% BNB + 100% LUNA of all claims and buy");
}
